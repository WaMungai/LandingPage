...
function CTA() {
  return (
    <>
      <div className="self-stretch  max-md:max-w-full max-md:mt-10 max-md:pr-0">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          <div className="flex flex-col items-stretch w-[42%] max-md:w-full max-md:ml-0">
            <div className="items-start flex flex-col my-auto py-px max-md:max-w-full max-md:mt-10">
              <div className="text-slate-600 text-4xl font-bold  self-start max-md:max-w-full">
                Power your retail business seize more sales
                <br />
              </div>
              <div className="text-black text-2xl font-normal mt-10 self-start max-md:max-w-full max-md:mt-10">
                Offer frictionless shopping experiences with a modern POS system
                that lets customers shop their way, from online to checkout
                line.
              </div>
                ...
                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                  ...
                  <div className="flex flex-col items-stretch w-[77%] ml-5 max-md:w-full max-md:ml-0">
                    <div className="items-start flex grow flex-col max-md:mt-7">
                      ...
                      <div className="text-neutral-400 text-lg leading-6 self-stretch mt-5">
                        Email customers their in-store favorites, right from the
                        POS system.
                      </div>
                    </div>
                  </div>
                ...
                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                  ...
                  <div className="flex flex-col items-stretch w-[77%] ml-5 max-md:w-full max-md:ml-0">
                    <div className="items-start flex grow flex-col max-md:mt-7">
                      ...
                      <div className="text-neutral-400 text-lg leading-6 self-stretch mt-5">
                        Accept in-store returns and exchanges of items bought
                        online or at other locations.
                      </div>
                    </div>
                  </div>
                </div>
