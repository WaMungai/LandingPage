    ...
    <div className="flex-col overflow-hidden self-stretch relative flex min-h-[1024px] w-full pt-36 pb-60 px-20 max-md:max-w-full max-md:px-5 max-md:py-24 bg-teal-500">
      ...
      <div className="relative items-center self-center flex mb-0 w-[740px] max-w-full flex-col max-md:mb-2.5">
        ...
        <div className="self-center flex w-[311px] max-w-full items-start gap-5 mt-8">
          <div className="text-white text-base font-bold leading-6 self-stretch whitespace-nowrap justify-center items-center border shadow-sm flex-1 pl-12 pr-12 py-2.5 rounded-[68px] border-solid border-white max-md:px-5 hover:bg-purple-500">
            Sign in
          </div>
          <div className="text-teal-700 text-base font-bold leading-6 self-stretch whitespace-nowrap justify-center items-center shadow-sm bg-white flex-1 px-11 py-2.5 rounded-[88px] max-md:px-5 hover:bg-purple-500">
            Sign up
