...
function CustomerReview() {
  return (
    <>
   <div className="items-start flex w-[632px] max-w-full grow flex-col mt-20 self-start max-md:mt-10 bg-teal-500">
...
<div className="flex flex-col pt-60 max-md:pt-24 bg-teal-500">
