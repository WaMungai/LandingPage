      ...
      <div className="bg-white flex flex-col mx-auto ">
        ...
        <div className="self-center z-[50] flex mt-0 w-full max-w-[1331px] flex-col max-md:max-w-full">
          ...
          <div className="items-center shadow-lg bg-slate-50 self-stretch flex flex-col mt-24 pb-24 rounded-2xl max-md:max-w-full max-md:mt-10">
            ...
            <div className="items-start self-center flex w-full max-w-[1233px] flex-col max-md:max-w-full px-24 ">
              <CarouselContainer />
              <div className="self-stretch mt-12 max-md:max-w-full max-md:mt-10 max-md:pr-5">
                <CTA />
              </div>
            </div>
          </div>
        ...
        <div className="self-center  flex mt-0 w-full max-w-[1331px] flex-col max-md:max-w-full">
          <Resources />
          <CustomerReview />
          <FAQ />
        </div>
